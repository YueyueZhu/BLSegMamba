...
wkv_cuda = load(name="wkv", sources=["/home/zyy/Modules/3DSegmentation/Zig-RiR/cuda/wkv_op.cpp", "/home/zyy/Modules/3DSegmentation/Zig-RiR/cuda/wkv_cuda.cu"],
...
if __name__ == '__main__':
    ...
    model = Z_RiR(in_channels=1,
                        out_channels=9,)
    # input_tensor = torch.randn(1, 1, 100, 128, 128).to(device)
    input_tensor = torch.randn(1, 1, 121, 128, 128).to(device)
