...
class DataLoaderMultiProcess:
    ...
    def generate_train_batch(self):
        ...
        for j, key in enumerate(selected_keys):
            ...
            # vals_lbl, counts_lbl = np.unique(seg, return_counts=True)
            # print(f"label  unique values: {vals_lbl}, counts: {counts_lbl}")
            ...
            # vals_lbl, counts_lbl = np.unique(seg_all, return_counts=True)
            # print(f"allseg  unique values: {vals_lbl}, counts: {counts_lbl}")
